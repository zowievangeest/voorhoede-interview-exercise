<template>
  <div v-if="blogPosts" class="container my-12 mx-auto px-4 md:px-12">
    <div class="flex flex-wrap flex-row mb-4">
      ...
      >
        ...
        >
          <article
            class="grow bg-white rounded-lg overflow-hidden shadow relative"
          >
            ...
            <div class="p-4 h-auto md:h-56 lg:h-64">
              <h1
                class="block text-voorhoede-blue font-semibold mb-2 text-lg md:text-base lg:text-lg h-12"
              >
                {{ post.title }}
              </h1>
              <div
